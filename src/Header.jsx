...
import profile from "./assets/Gabriel Giorgadze.jpg";

const navigation = [
  { name: "მთავარი", href: "#", current: true },
  { name: "სერვისები", href: "#services", current: false },
  { name: "ჩვენ შესახებ", href: "#about-us", current: false },
  { name: "კონტაქტი", href: "#", current: false },
];
        ...
        <div className="relative flex h-16 items-center justify-between">
          ...
          <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
            <div className="flex shrink-0 items-center">
              <a href="https://rowix.com" target="blank">
